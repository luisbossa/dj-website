          ...
          if (p) {
            ...
            C({
              ...
              var E = S === e && 0 === p,
                ...
                g = M({ element: u, actionItem: t, elementApi: m }, v);
              gt({
                store: n,
                element: u,
                actionItem: t,
        ...
        function N(e, r, i, o) {
          ...
          if (!n || i.force) {
            ...
            if (p && p.length) {
              ...
              for (var h = s(r), E = { omit3d: !u }, _ = 0; _ < p.length; _++)
                x(h, p[_], E);
              E.start ? h.then(g) : g();
            }
          }
    ...
    function Lt(t) {
      ...
      e.actionItems.forEach(function (t) {
        ...
        (e = (0, _.isPluginType)(i)
          ? (0, _.clearPlugin)(i)
          : Mt({ effect: Dt, actionTypeId: i, elementApi: r })),
      ...
      triggers: [
        {
          ...
          stepsA: [
            { wait: "70ms" },
            { opacity: 0, transition: "opacity 350ms ease 0" },
            { display: "none" },
          ],
          stepsB: [],
        },
...
Webflow.require("ix2").init({
  events: {
    ...
    "e-5": {
      ...
      createdOn: 1533730773627,
    },
  },
  actionLists: {
    a: {
      id: "a",
      title: "Mountain Movement",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      selector: ".dj-image",
                      selectorGuids: ["a1cb39a0-daf4-8041-3176-7a03e946fd16"],
                    },
                    xValue: 3,
                    xUnit: "PX",
                    yUnit: "PX",
